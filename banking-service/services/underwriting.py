...
def get_pending_exceptions(table_ref: str) -> list[DocumentSummaryResponse]:
    """
    Retrieves all artifacts currently in 'MISMATCH' exception status from BigQuery.
    """
...
def apply_underwriting_override(table_ref: str, override: UnderwritingOverrideRequest) -> bool:
    """
...
def get_artifact_gcs_path(table_ref: str, artifact_id: str) -> str:
    """
    Retrieves the GCS file path for a specific artifact ID.
    """
