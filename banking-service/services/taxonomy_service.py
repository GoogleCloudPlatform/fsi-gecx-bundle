...
DEFAULT_TAXONOMY_MAP: Dict[str, Dict[str, str]] = {
    ...
    "5200": {"primary": "HOME_IMPROVEMENT", "detailed": "HOME_IMPROVEMENT_HARDWARE"},
    "5912": {"primary": "HEALTHCARE", "detailed": "HEALTHCARE_PHARMACIES"},
    "7298": {"primary": "PERSONAL_CARE", "detailed": "PERSONAL_CARE_SPAS"},
