...
class CardAuthHoldRequest(BaseModel):
    ...
    merchant_id: str | None = Field(None, description="Internal merchant UUID when resolved")
    merchant_slug: str | None = Field(None, description="Stable merchant catalog slug when resolved")
    merchant_store_id: str | None = Field(None, description="Internal merchant store UUID when resolved")
