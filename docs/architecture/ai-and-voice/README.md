...
| [Agent Trajectory Evaluation](./agent_trajectory_evaluation.md) | Runtime-neutral ADK/CES event model, release evidence layers, protected-consent samples, and trajectory qualification commands. |
