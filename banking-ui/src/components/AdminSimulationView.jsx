  ...
  return (
    <section className="relative pt-24 pb-16 md:pt-28 md:pb-24 px-6 max-w-7xl mx-auto min-h-[calc(100vh-80px)] flex flex-col text-left">
      ...
      <div className="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-200 dark:border-slate-800 pb-6">
        <div>
          <AnalyticsButton analyticsId="admin_simulation_view_back_to_admin_portal" 
        ...
        {isMonitoring && (
          <div className="flex items-center gap-2 self-start md:self-end">
            <AnalyticsButton analyticsId="admin_simulation_view_take_operations_monitor_tour"
            ...
            <AnalyticsButton analyticsId="admin_simulation_view_refresh_summary_metrics_now_live_transaction_rows_continue"
        ...
        {!isMonitoring && (
          <div className="flex items-center gap-2 self-start md:self-end">
            <AnalyticsButton analyticsId="admin_simulation_view_take_simulation_studio_tour"
              id="studio-tour-btn"
              onClick={() => {
            ...
            <div className="mb-4 flex items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                <span className={`px-3 py-1 rounded-full border text-[10px] font-black ${walStatus.className}`}>{walStatus.label}</span>
                  <AnalyticsButton analyticsId="admin_simulation_view_explain_live_stream_status_cdc_freshness_event_age_and_throu_info_modal"
            ...
            <div className="p-5 rounded-3xl bg-white/80 dark:bg-slate-900/80 border border-slate-200/80 dark:border-slate-800/80 shadow-xl shadow-slate-950/5" id="risk-alerts-overview">
              <div className="mb-4 flex items-center justify-between">
                <div>
                  ...
                  <AnalyticsButton analyticsId="admin_simulation_view_explain_flagged_activity_risk_scoring_pending_exposure_and_m_info_modal"
      ...
      <div className="mb-10" id="immediate-actions">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="p-4 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-slate-200/80 dark:border-slate-800/80 shadow-lg shadow-slate-950/5 transition-all hover:-translate-y-0.5 hover:shadow-xl hover:shadow-slate-950/10 flex flex-col">
            ...
            <AnalyticsButton analyticsId="admin_simulation_view_07"
          ...
          <div className="p-4 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-slate-200/80 dark:border-slate-800/80 shadow-lg shadow-slate-950/5 transition-all hover:-translate-y-0.5 hover:shadow-xl hover:shadow-slate-950/10 flex flex-col">
            ...
            <AnalyticsButton analyticsId="admin_simulation_view_08"
          ...
          <div className="p-4 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-slate-200/80 dark:border-slate-800/80 shadow-lg shadow-slate-950/5 transition-all hover:-translate-y-0.5 hover:shadow-xl hover:shadow-slate-950/10 flex flex-col">
            ...
            <AnalyticsButton analyticsId="admin_simulation_view_09"
          ...
          <div className="min-w-0">
            ...
            <div className="flex items-center gap-3">
              <h2 className="text-lg font-bold text-slate-900 dark:text-white">Scenario Composer</h2>
                <AnalyticsButton analyticsId="admin_simulation_view_explain_dry_runs_immediate_launches_replays_and_scheduled_sc_info_modal"
        ...
        <div className="mt-5 grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-5">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="grid grid-cols-2 gap-2" id="scenario-composer-actions">
              <AnalyticsButton analyticsId="admin_simulation_view_generate_and_validate_a_scenario_plan_without_writing_transa"
              ...
              <AnalyticsButton analyticsId="admin_simulation_view_create_the_scenario_transactions_immediately_through_banking"
              ...
              <AnalyticsButton analyticsId="admin_simulation_view_run_the_most_recent_dry_run_plan_again_without_generating_a"
              ...
              <AnalyticsButton analyticsId="admin_simulation_view_queue_the_scenario_through_cloud_tasks_so_events_are_dispa"
      ...
      <div className="mb-10 p-6 rounded-3xl bg-white/80 dark:bg-slate-900/80 border border-slate-200/80 dark:border-slate-800/80 shadow-xl shadow-slate-950/5">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-5 pb-4 border-b border-slate-200/60 dark:border-slate-800/60">
          ...
          <AnalyticsButton analyticsId="admin_simulation_view_refresh_scheduled_scenario_run_status_from_banking_service"
      ...
      <aside className="space-y-4 xl:sticky xl:top-24">
        ...
        <div className="rounded-3xl bg-white/80 dark:bg-slate-900/80 border border-slate-200/80 dark:border-slate-800/80 shadow-xl shadow-slate-950/5 p-4">
          ...
          <AnalyticsButton analyticsId="admin_simulation_view_view_details"
            onClick={refreshScheduledEvents}
        ...
        <div className={`mb-8 p-5 rounded-2xl border backdrop-blur-md flex items-start gap-4 transition-all duration-300 shadow-xl animate-fade-in ${
          ...
          <div className="flex-1 overflow-hidden">
            <div className="flex items-center justify-between">
              ...
              <AnalyticsButton analyticsId="admin_simulation_view_hide"
