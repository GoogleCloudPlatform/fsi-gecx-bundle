  ...
  return (
    <div className="relative pt-24 pb-16 md:pt-28 md:pb-24 px-6 max-w-7xl mx-auto min-h-[calc(100vh-80px)] flex flex-col justify-between text-slate-800 dark:text-slate-100">
      ...
      <div className="mb-6 flex justify-between items-center border-b border-slate-200 dark:border-slate-805 pb-4 w-full">
        <div>
          <AnalyticsButton trackingName="agent_support_dashboard_back_to_admin_portal" 
        ...
        <div className="flex items-center gap-3">
          <AnalyticsButton trackingName="agent_support_dashboard_take_supervisor_console_tour"
          ...
          {isConnected && (
            ...
            <AnalyticsButton trackingName="agent_support_dashboard_gcp_co_browse_integration_info_modal"
          ...
          {selectedEscalation ? (
            <div className="flex flex-col justify-between h-full gap-6">
              ...
              <div className="flex justify-between items-start border-b border-slate-200 dark:border-slate-800 pb-4" id="takeover-session-header">
                ...
                {!isConnected ? (
                  <AnalyticsButton trackingName="agent_support_dashboard_04"
                  ...
                  <AnalyticsButton trackingName="agent_support_dashboard_disconnect_session"
                    onClick={endCall}
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex gap-1.5">
                              <AnalyticsButton trackingName="agent_support_dashboard_highlight"
                              ...
                              {tx.amount_cents < 0 && (
                                <AnalyticsButton trackingName="agent_support_dashboard_reverse_charge"
              ...
              <div className="border-t border-slate-205 dark:border-slate-800 pt-4 mt-2" id="supervisor-quick-actions">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="flex items-center justify-between p-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/30">
                    ...
                    <AnalyticsButton trackingName="agent_support_dashboard_freeze_credit_card"
                  ...
                  <div className="flex items-center justify-between p-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/30">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <AnalyticsButton trackingName="agent_support_dashboard_update"
