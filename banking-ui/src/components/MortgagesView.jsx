              ...
              return (
                ...
                >
                  ...
                  <div className="pt-4 flex flex-wrap gap-3 items-center justify-between">
                    <AnalyticsButton trackingName="mortgages_view_connect_program_context"
                    ...
                    {activeBot !== undefined && setActiveBot && (
                      <AnalyticsButton trackingName="mortgages_view_ask_advisor" 
                        onClick={() => {
        ...
        <div className="fixed inset-0 z-[200] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 animate-fade-in">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl max-w-lg w-full overflow-hidden shadow-2xl">
            ...
            <div className="p-6 border-b border-slate-200 dark:border-slate-800 flex justify-between items-center bg-slate-50 dark:bg-slate-950/50">
              ...
              <AnalyticsButton trackingName="mortgages_view_03" 
                ...
                <form onSubmit={handleApplySubmit} className="space-y-6">
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <AnalyticsButton trackingName="mortgages_view_existing_member_line"
                        type="button"
                      ...
                      <AnalyticsButton trackingName="mortgages_view_new_prospective_line"
                        type="button"
                  ...
                  <div className="space-y-3 pt-2">
                    <AnalyticsButton trackingName="mortgages_view_06"
                      type="submit"
