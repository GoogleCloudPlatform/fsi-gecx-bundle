      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-slate-950/80 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800/50">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4 shrink-0">
            ...
            <button 
              className="hidden sm:block px-5 py-2.5 rounded-full text-slate-950 font-semibold text-sm shadow-lg hover:scale-105 transition-all duration-300"
            ...
            <button
              ...
              className="md:hidden p-2 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors cursor-pointer flex items-center justify-center"
