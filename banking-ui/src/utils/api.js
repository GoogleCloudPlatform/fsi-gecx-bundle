...
export async function getCreditCardVoiceToken(mode = 'audio', locale = undefined) {
...
export async function deprovisionMyDemo() {
  const res = await api.post('v1/simulation/deprovision-my-demo');
  return res.data;
}
