...
envsubst "\$VITE_BANKING_API_URL \$VITE_CCAI_COMPANY_ID \$VITE_CCAI_HOST \$VITE_CX_AGENT_STUDIO_DEPLOYMENT_NAME \$VITE_CX_AGENT_STUDIO_UPLOAD_TOOL_NAME \$VITE_CX_AGENT_STUDIO_POPULATE_FORM_CONTENT_TOOL_NAME \$VITE_CX_AGENT_STUDIO_GET_USER_LOCATION_TOOL_NAME \$LIVEKIT_URL \$VITE_SHOW_INFO_MODALS" < /usr/share/nginx/html/config.template.js > /usr/share/nginx/html/config.js
